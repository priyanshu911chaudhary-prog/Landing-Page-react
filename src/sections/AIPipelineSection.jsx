          ...
          <div>
            ...
            <div className="space-y-2.5">
              {PIPELINE_STAGES.map((step, idx) => (
                <div key={step.id} data-motion="section-card">
                  <div className={`group relative rounded-xl border border-slate-700/45 ${step.borderAccent} border-l-2 bg-slate-900/35 p-4 backdrop-blur-sm hover:border-slate-600/70 transition-colors`}>
                    <div
                      aria-hidden="true"
            ...
            <div data-reveal className="mt-4 rounded-xl border border-slate-700/40 bg-slate-900/30 px-4 py-2.5 flex items-center gap-3">
